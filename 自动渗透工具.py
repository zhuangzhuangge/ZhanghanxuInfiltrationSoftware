...
class home ( wx.Frame ):     #主页面框体
	...
	def __init__( self, parent ):
		...
		self.m_button11 = wx.Button( self, wx.ID_ANY, u"自动渗透测试", wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer7.Add( self.m_button11, 0, wx.ALL|wx.ALIGN_CENTER_HORIZONTAL, 5 )

		self.m_button12 = wx.Button( self, wx.ID_ANY, u"单项渗透工具", wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer7.Add( self.m_button12, 0, wx.ALL|wx.ALIGN_CENTER_HORIZONTAL, 5 )
		...
		self.m_button11.Bind(wx.EVT_BUTTON, self.switch1)
		self.m_button12.Bind(wx.EVT_BUTTON, self.switch2)
...
class home2 ( wx.Frame ):    #单项渗透工具框体
	...
	def __init__( self, parent ):
		...
		self.m_button13 = wx.Button( self, wx.ID_ANY, u"域名反查", wx.DefaultPosition, wx.DefaultSize, 0 )
		gSizer1.Add( self.m_button13, 0, wx.ALL, 5 )

		self.m_button14 = wx.Button( self, wx.ID_ANY, u"后台扫描", wx.DefaultPosition, wx.DefaultSize, 0 )
		gSizer1.Add( self.m_button14, 0, wx.ALL, 5 )

		self.m_button15 = wx.Button( self, wx.ID_ANY, u"端口开放扫描", wx.DefaultPosition, wx.DefaultSize, 0 )
		gSizer1.Add( self.m_button15, 0, wx.ALL, 5 )

		self.m_button16 = wx.Button( self, wx.ID_ANY, u"C段HTTP扫描", wx.DefaultPosition, wx.DefaultSize, 0 )
		gSizer1.Add( self.m_button16, 0, wx.ALL, 5 )

		self.m_button17 = wx.Button( self, wx.ID_ANY, u"网站备份扫描", wx.DefaultPosition, wx.DefaultSize, 0 )
		gSizer1.Add( self.m_button17, 0, wx.ALL, 5 )

		self.m_button18 = wx.Button( self, wx.ID_ANY, u"信息搜集", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_button13.Bind(wx.EVT_BUTTON, self.switch1)
		self.m_button14.Bind(wx.EVT_BUTTON, self.switch2)
		self.m_button15.Bind(wx.EVT_BUTTON, self.switch3)
		self.m_button16.Bind(wx.EVT_BUTTON, self.switch4)
	...
	def switch6(self, event):
		event.Skip()
		F6 = XXSJ(frame)
		F6.Show()

	def switch7(self, event):
		event.Skip()
		F7 = xssJC(frame)
		F7.Show()
...
class CDSM ( wx.Frame ):     #C段HTTP端口扫描框体
	...
	def run(self):
		...
		while True:
			if self._queue.empty():
				break
			number = self._queue.get(timeout=0.5)
			BF = ['/www.zip', '/www.rar', '/root.zip', '/root.rar', '/admin.zip', '/admin.rar', '/1.rar', '/1.zip',
				  '/123.zip', '/123.rar', '/wwwroot.zip', '/wwwroot.rar', '/backup.rar', '/backup.zip', '/back.rar',
				  '/back.zip', '/web.rar', '/web.zip', '/test.zip', '/test.rar']
			if 'www' in number:
				xz1 = '/' + str(number) + '.rar'
				BF.append(xz1)
				xz2 = '/' + str(number) + '.zip'
